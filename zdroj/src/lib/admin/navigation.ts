...
export const ADMIN_SIDEBAR_GROUPS: AdminNavGroup[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'workers-bulk', label: 'Hromadné zprávy', href: '/admin/pracovnici-portalu/hromadne-zpravy', icon: '✉', tone: 'blue' },
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'accommodation-hotelbeds', label: 'Hotelbeds / HBX', href: '/admin/integrace/ubytovani/hotelbeds', icon: '🏨', tone: 'blue' },
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'ai-chat', label: 'AI chat', href: '/admin/marketing/ai-chat', icon: '💬', tone: 'purple' },
      { id: 'ai-sales', label: 'AI obchodník', href: '/admin/marketing/ai-sales', icon: '🤝', tone: 'purple' },
      ...
      { id: 'aktuality', label: 'Redakční centrum', href: '/admin/redakce', icon: '📰', tone: 'purple' },
      { id: 'aktuality-legacy', label: 'AI redakce (legacy)', href: '/admin/aktuality', icon: '✍', tone: 'purple' },
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'hotelbeds-int', label: 'Hotelbeds / HBX', href: '/admin/integrace/ubytovani/hotelbeds', icon: '🏨', tone: 'blue' },
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'support-email', label: 'E-mailové adresy', href: '/admin/nastaveni/emailove-adresy', icon: '✉', tone: 'blue' },
      { id: 'listing-settings', label: 'Inzeráty', href: '/admin/nastaveni-inzeraty', icon: '🏘' },
      { id: 'verification-files', label: 'Ověřovací soubory', href: '/admin/overovaci-soubory', icon: '📄', tone: 'green' },
