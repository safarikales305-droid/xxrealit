...
import { PromoProfilesController, PortalProfilesController } from './promo-profiles.controller';
...
@Module({
  ...
  controllers: [PromoProfilesController, PortalProfilesController, PromoProfilesAdminController],
