...
export function serializeCompanyDirectoryDetail(row: CompanyDirectoryEntry) {
  ...
  return {
    ...
    discoveredEmail: row.discoveredEmail,
    emailSourceUrl: row.emailSourceUrl,
    emailConfidence: row.emailConfidence,
    websiteSource: row.websiteSource,
    websiteConfidence: row.websiteConfidence,
    websiteVerifiedAt: row.websiteVerifiedAt?.toISOString() ?? null,
    shortDescription: row.shortDescription,
    description: row.description,
    enrichmentStatus: row.enrichmentStatus,
    enrichmentData: row.enrichmentData,
    contentEnrichedAt: row.contentEnrichedAt?.toISOString() ?? null,
    ...
    socialIntroPublishedAt: row.socialIntroPublishedAt?.toISOString() ?? null,
