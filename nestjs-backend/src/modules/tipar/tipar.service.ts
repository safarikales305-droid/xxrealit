  ...
  async activateTipar(userId: string) {
    const existing = await this.prisma.user.findUnique({
      ...
      select: {
        ...
        agentProfile: { select: { city: true, fullName: true, ico: true, companyName: true } },
        companyProfile: { select: { city: true, contactFullName: true, ico: true, companyName: true } },
        agencyProfile: { select: { city: true, contactFullName: true, ico: true, agencyName: true } },
        financialAdvisorProfile: { select: { city: true, fullName: true, ico: true } },
        investorProfile: { select: { city: true, fullName: true } },
      },
    });
