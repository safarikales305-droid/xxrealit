  ...
  async sendTemplateTest(
    ...
    await this.emails.sendTemplatedEmail({
      ...
      variables: {
        ...
        ctaUrl: 'https://xxrealit.cz',
        title: 'Test šablony',
        subject: 'Test šablony',
        contentHtml: '<p>Toto je testovací obsah.</p>',
        contentText: 'Toto je testovací obsah.',
        resetUrl: 'https://xxrealit.cz/reset-hesla?token=test',
        verifyUrl: 'https://xxrealit.cz/verify-email?token=test',
        completeRegistrationUrl: 'https://xxrealit.cz/dokoncit-registraci-pracovnik?token=test',
        setPasswordUrl: 'https://xxrealit.cz/dokoncit-registraci-pracovnik?token=test',
        loginUrl: 'https://xxrealit.cz/login',
        portalName: 'XXrealit.cz',
        supportEmail: 'podpora@xxrealit.cz',
        profileUrl: 'https://xxrealit.cz/profil',
        listingTitle: 'Testovací inzerát',
        listingLocation: 'Praha',
        listingPrice: '1 000 000 Kč',
        listingUrl: 'https://xxrealit.cz/nemovitost/test',
